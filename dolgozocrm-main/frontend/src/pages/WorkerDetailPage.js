    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-2xl lg:text-3xl font-bold text-slate-800" data-testid="worker-name">
            {worker.name}
          </h1>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <h2 className="font-semibold text-slate-800 mb-4">Elérhetőségek</h2>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href={`tel:${worker.phone}`} className="font-medium text-slate-800 hover:text-indigo-600" data-testid="worker-phone">{worker.phone}</a>
                    </div>
                  </div>
                  {worker.email && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <a href={`mailto:${worker.email}`} className="font-medium text-slate-800 hover:text-indigo-600">{worker.email}</a>
                      </div>
                    </div>
                  )}
                  {worker.address && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-slate-500">Lakcím</p>
                        <p className="font-medium text-slate-800">{worker.address}</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              {worker.position_experience && (
                <div className="bg-white rounded-xl border border-slate-200 p-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-medium text-slate-700">Pozíció tapasztalat</h3>
                  </div>
                  <p className="text-slate-600 whitespace-pre-wrap">{worker.position_experience}</p>
                </div>
              )}
                  ...
                  {worker.experience && (
                    <div className="mb-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-medium text-slate-700">Általános tapasztalat</h3>
                      </div>
                      <p className="text-slate-600 whitespace-pre-wrap">{worker.experience}</p>
                    </div>
                  )}
                  {worker.notes && (
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-medium text-slate-700">Megjegyzések</h3>
                      </div>
                      <p className="text-slate-600 whitespace-pre-wrap">{worker.notes}</p>
                    </div>
                  )}
                </div>
              )}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="font-semibold text-slate-800">Jellemzők</h2>
                </div>
              ...
              {/* Meta */}
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <h2 className="font-semibold text-slate-800 mb-4">Részletek</h2>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <span className="text-slate-500">Felvéve</span>
                    <span className="text-slate-800">
                      {new Date(worker.created_at).toLocaleDateString('hu-HU')}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-500">Felvitte</span>
                    <span className="text-slate-800">{worker.owner_name}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-500">Projektek</span>
                    <span className="text-slate-800">{worker.project_statuses?.length || 0}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <TabsContent value="history">
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="font-semibold text-slate-800">Projekt előzmények</h2>
            </div>
            ...
            {worker.project_statuses?.length > 0 ? (
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex-1">
                        ...
                        {ps.notes && (
                          <div className="mt-2 p-2 bg-white/50 rounded text-sm text-slate-600 flex items-start gap-2">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-slate-500">Még nincs projekthez rendelve</p>
                <p className="text-sm text-slate-400 mt-1">A projekt részvételek és státuszok itt fognak megjelenni</p>
              </div>
            )}
          </div>
        </TabsContent>
